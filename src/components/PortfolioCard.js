...
function PortfolioCard({
  ...
  return (
    <div className={` ${index % 4 === 0 ? '' : 'border-l-1'} border-grid border-t-1 project-card p-6 cursor-default group hover:scale-100 duration-200 overflow-hidden relative w-full h-full`}>
      <div className="flex">
