    ...
    <div className="fixed left-4 top-3/4 text-slate-300 text-3xl">
      ...
      <div className="center-overlay hover:-translate-y-1 hover:text-teal-400 duration-300 my-4 w-6 h-6">
        <a href="https://www.instagram.com/_jren2/" aria-label="Instagram" target="_blank" rel="noreferrer" cursorshover="true">
          <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-instagram" cursorshover="true">
