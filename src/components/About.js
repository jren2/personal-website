...
const paragraphs = [
  ...
  "💻 I'm especially interested in fullstack web dev and distributed, low-latency systems and am excited about solving challenging problems through software. I'm always exploring new concepts and opportunities to grow a vast problem solving background!",
  "⚽ Beyond programming, I've been playing soccer since I was 6 years old and am also an avid music lover! My favorite artist right now is Laufey and my favorite instrument is the violin (recently played for the Penn Symphony Orchestra)!",
];
