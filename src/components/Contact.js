      ...
      <div id="contact" className="w-full bg-white-background m-auto">
        ...
        {/* <div className="relative mb-2 w-fit mx-auto text-3xl font-medium text-slate-200">
          <div
            ...
            className="typeDisappear absolute w-full h-full bg-zinc-900"
          />
          Contact
        </div>
        <div
          className="mb-2 text-center text-base font-medium tracking-wide text-slate-200/50"
        >
          Feel free to reach out to me through any of the resources below!
        </div>
