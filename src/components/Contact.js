  ...
  <>
    <div>
      <div id="contact" className="bg-zinc-900 m-auto w-fit pt-10 pb-20 px-20">
        <div className="mb-10 w-fit mx-auto text-3xl font-medium tracking-wider text-slate-200">
          Contact
        </div>
        ...
        <div className="text-center mt-14 flex xs:flex-col md:flex-row">
          ...
          <div className="flex xs:flex-col m-auto sm:flex-row">
            ...
            <a href="https://www.linkedin.com/in/jason-ren-89855b203/" target="_blank" className="relative xs:mx-4 xs:my-4 xl:my-0 sm:mx-8 border-teal-400 border-2 inline-flex items-center justify-start px-9 p-3 overflow-hidden transition-all rounded-xl group" rel="noreferrer">
              <span className="w-48 h-48 rounded rotate-[-40deg] bg-gradient-to-r from-blue-400 via-teal-500 to-teal-500 absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0" />
